...
const resources = {
  en: {
    translation: {
      ...
      "Camera is in use or unavailable. Close other apps using the camera and try again.": "Camera is in use or unavailable. Close other apps using the camera and try again.",
      "Camera is not supported in this browser.": "Camera is not supported in this browser.",
      "Could not open the camera. Please try again.": "Could not open the camera. Please try again.",
      "Location access was blocked or timed out. You can continue; GPS tagging may be limited.": "Location access was blocked or timed out. You can continue; GPS tagging may be limited.",
      "Try again": "Try again",
      "Missing link data": "Missing link data",
      "This step needs a valid inspection link (user id and session id). Use the link you were sent or contact support.": "This step needs a valid inspection link (user id and session id). Use the link you were sent or contact support.",
      "Go back": "Go back",
  ...
  ar: {
    translation: {
      ...
      "Camera is in use or unavailable. Close other apps using the camera and try again.": "الكاميرا قيد الاستخدام أو غير متاحة. أغلق التطبيقات الأخرى التي تستخدم الكاميرا وحاول مرة أخرى.",
      "Camera is not supported in this browser.": "المتصفح لا يدعم الكاميرا.",
      "Could not open the camera. Please try again.": "تعذر فتح الكاميرا. يرجى المحاولة مرة أخرى.",
      "Location access was blocked or timed out. You can continue; GPS tagging may be limited.": "تم حظر الموقع أو انتهت المهلة. يمكنك المتابعة؛ قد يكون تسجيل GPS محدوداً.",
      "Try again": "حاول مرة أخرى",
      "Missing link data": "بيانات الرابط ناقصة",
      "This step needs a valid inspection link (user id and session id). Use the link you were sent or contact support.": "هذه الخطوة تحتاج رابط فحص صالح (معرف المستخدم وجلسة). استخدم الرابط المرسل لك أو تواصل مع الدعم.",
      "Go back": "رجوع",
      ...
      "I understand": "فهمت",
      "Waiting for camera…": "جاري تشغيل الكاميرا...",
      "front": "أمام",
      "rear": "خلف",
      "left": "يسار",
      "right": "يمين",

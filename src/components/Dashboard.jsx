...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans text-sm">
      ...
      {/* ── Admin Sub-users Page ── */}
      {activeNav === "adminSubUsers" && (
        <main className="p-5">
          <UserAccessControl isAdminSubUsers={true} />
        </main>
      )}

      {/* ── Main Content ── */}
      {activeNav !== "transaction" && activeNav !== "userControl" && activeNav !== "adminSubUsers" && <main className="p-5">

    ...
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <div className="bg-white px-6 pt-10 pb-6 shadow-sm">
        <div className="flex items-center gap-3 mb-3">
          ...
          <p className="text-xs text-gray-400">{requiredPhotos.length + wsPhotos.length} of {requiredPhotos.length + wsPhotos.length} captured</p>
          </div>
        </div>
        ...
        {wsPhotos.length > 0 && (
          <>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-3">
              Vehicle Side Photos ({wsPhotos.length})
            </p>
                ...
                <div key={photo.sideId} className="bg-white rounded-2xl overflow-hidden shadow-sm">
                  ...
                  <div className="px-3 py-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-2 py-1 rounded-lg text-xs font-semibold text-white bg-green-600 hover:bg-green-700 transition-colors"
                    >
                      Retake
                    </button>
                  </div>
    ...
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <div className="bg-white px-6 pt-10 pb-6 text-center shadow-sm">
        ...
        <p className="text-gray-500 text-sm">
          {allPhotos.length} photo{allPhotos.length !== 1 ? 's' : ''} total · {requiredPhotos.length + wsPhotos.length} required · {extraPhotos.length} additional
        </p>
      </div>
